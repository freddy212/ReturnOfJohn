...
fun spawnEngineerItems(location: DefaultLocation): List<GameObject>{
    val itemTable = GenericGameObject(location.topright - Vector2(200f,150f),
...
fun spawnDoorOne(location: DefaultLocation): List<GameObject>{
    ...
    val wastelandDoorCollition = DoorCollition(wastelandDoorPosition,
        AreaIdentifier.WASTELAND, doorWastelandAndMainAreaConnection2,
        Direction.LEFT)
    val wastelandDoor = Door(wastelandDoorPosition, Vector2(32f * 2, 32f * 2),DefaultTextureHandler.getTexture("EmptyDoor.png"),location,
...
fun spawnDoorTwo(location: DefaultLocation): List<GameObject>{
    ...
    val mainAreaDoorCollition = DoorCollition(mainAreaDoorPosition,AreaIdentifier.MAINAREA, doorWastelandAndMainAreaConnection2,Direction.RIGHT)
    val mainAreaDoor = Door(mainAreaDoorPosition, Vector2(32f * 2, 32f * 2),DefaultTextureHandler.getTexture("EmptyDoor.png"),location,
