...
enum class SIGNALTYPE{ITEM_PICKED_UP,REMOVE_OBJECT, ABILITY_GAINED, USE_ITEMS, CHANGE_OBJECT_LOCATION, MOVE_OBJECT, ADD_OBJECT, CHANGE_CONVERSATION, BUTTON_ACCEPTED, MAX_HEALTH_GAINED }
