...
class GenericItemObject(Position: Vector2, size: Vector2, defaultLocation: DefaultLocation, item: Item, texture: Texture) : GameObject(Position, size,defaultLocation),ItemObject,
