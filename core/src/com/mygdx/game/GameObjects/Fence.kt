...
import com.mygdx.game.TerrainManager
...
class Fence(Position: Vector2, size: Vector2): GameObject(Position,size) {
    ...
    override val spriteToRender = InitSprite(start_Texture)
    ...
    init {
        ...
        TerrainManager.collitionPolygons.add(Pair(RectanglePolygon(spriteToRender.boundingRectangle), illegalMoveCollition))
    }
