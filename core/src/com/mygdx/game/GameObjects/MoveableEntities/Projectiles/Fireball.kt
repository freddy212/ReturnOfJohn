...
class Fireball(Position: Vector2, size: Vector2, defaultLocation: DefaultLocation?, unitVectorDirection: Vector2) : Projectile(Position, size, defaultLocation,unitVectorDirection) {
    override var currentSpeed = 6f
