...
class SmallDevil(Position: Vector2, size: Vector2 = Vector2(128f,128f),location: DefaultLocation?)
    ...
    private val randomAction = RandomAction(listOf( EnemyMoveBasedOnPlayer(0f,::getUnitVectorTowardsPoint, this),
                                            EnemyMoveBasedOnPlayer(200f,::getUnitVectorTowardsPoint, this),
                                            EnemyMoveBasedOnPlayer(200f,::getOppositeUnitVector, this)),DefaultTimer(2f), this)
