...
class RockMonster(Position: Vector2, size: Vector2 = Vector2(128f,128f),location: DefaultLocation?)
    ...
    private val randomAction = RandomAction(listOf(  EnemyMove(200f,::getOppositeUnitVector, this),
        EnemyMove(200f,::getUnitVectorTowardsPoint, this)),DefaultTimer(2f),this)
    override val enemyStrategy =  DefaultEnemyStrategy(listOf(randomAction,
        ShootProjectile(::SmallBoulder, Vector2(50f, 50f),this), EnemyRoll(EnemyMove(0f,::getUnitVectorTowardsPoint, this),this)))
