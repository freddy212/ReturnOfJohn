...
class TalkSensor(Position: Vector2, size: Vector2, character: NPC, override var direction: Direction) : GameObject(Position, size),DirectionalObject,
DynamicEntity by DefaultPositionChange{
    ...
    override val collition = TalkCollition
}